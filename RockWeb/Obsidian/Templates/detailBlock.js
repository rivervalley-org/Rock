System.register(['tslib', 'vue', '@Obsidian/Controls/panel', '@Obsidian/Controls/modal', '@Obsidian/Utility/promiseUtils', '@Obsidian/Controls/auditDetail', '@Obsidian/Controls/badgeList', '@Obsidian/Controls/entityTagList', '@Obsidian/Controls/rockButton', '@Obsidian/Controls/rockForm', '@Obsidian/Controls/rockSuspense', '@Obsidian/Utility/component', '@Obsidian/Utility/dialogs', '@Obsidian/Utility/http', '@Obsidian/Utility/url', '@Obsidian/Utility/booleanUtils'], (function (exports) {
    'use strict';
    var __awaiter, defineComponent, ref, computed, watch, Panel, Modal, isPromise, PromiseCompletionSource, AuditDetail, BadgeList, EntityTagList, RockButton, RockForm, RockSuspense, useVModelPassthrough, alert, confirmDelete, useHttp, makeUrlRedirectSafe, asBooleanOrNull;
    return {
        ...
        execute: (function () {
            ...
            var detailBlock = exports('default', defineComponent({
                ...
                setup(props, { emit }) {
                    ...
                    const isAutoEditMode = ref((_a = asBooleanOrNull(params.get("autoEdit"))) !== null && _a !== void 0 ? _a : false);
                    ...
                    const isViewMode = computed(() => {
                        return internalMode.value === 0 && !isAutoEditMode.value;
                    });
