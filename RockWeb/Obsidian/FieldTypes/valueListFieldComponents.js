  ...
  return {
    ...
    execute: (function () {
      ...
      function parseModelValue(modelValue) {
        try {
          return JSON.parse(modelValue !== null && modelValue !== void 0 ? modelValue : "[]").map(s => ({
            value: s
          }));
        } catch (_unused) {
          return [];
      ...
      var EditComponent = exports('EditComponent', defineComponent({
        ...
        setup(props, _ref) {
          ...
          var hasValues = computed(() => valueOptions.value !== null && valueOptions.value.length > 0);
          var valuePlaceholder = computed(() => {
            var _props$configurationV2;
            return (_props$configurationV2 = props.configurationValues[ConfigurationValueKey.ValuePrompt]) !== null && _props$configurationV2 !== void 0 ? _props$configurationV2 : "";
          });
          ...
          var onAddClick = () => {
            var defaultValue = "";
            if (hasValues.value) {
              var _valueOptions$value$;
              defaultValue = (_valueOptions$value$ = valueOptions.value[0].value) !== null && _valueOptions$value$ !== void 0 ? _valueOptions$value$ : "";
            }
      ...
      var ConfigurationComponent = exports('ConfigurationComponent', defineComponent({
        ...
        setup(props, _ref2) {
          ...
          var maybeUpdateModelValue = () => {
            var _labelPrompt$value, _definedType$value, _internalCustomValues, _asTrueFalseOrNull, _props$modelValue$Con, _props$modelValue$Con2, _props$modelValue$Con3, _props$modelValue$Con4;
            var newValue = {};
            ...
            var anyValueChanged = newValue[ConfigurationValueKey.ValuePrompt] !== ((_props$modelValue$Con = props.modelValue[ConfigurationValueKey.ValuePrompt]) !== null && _props$modelValue$Con !== void 0 ? _props$modelValue$Con : "") || newValue[ConfigurationValueKey.DefinedType] !== ((_props$modelValue$Con2 = props.modelValue[ConfigurationValueKey.DefinedType]) !== null && _props$modelValue$Con2 !== void 0 ? _props$modelValue$Con2 : "") || newValue[ConfigurationValueKey.CustomValues] !== ((_props$modelValue$Con3 = props.modelValue[ConfigurationValueKey.CustomValues]) !== null && _props$modelValue$Con3 !== void 0 ? _props$modelValue$Con3 : "") || newValue[ConfigurationValueKey.AllowHtml] !== ((_props$modelValue$Con4 = props.modelValue[ConfigurationValueKey.AllowHtml]) !== null && _props$modelValue$Con4 !== void 0 ? _props$modelValue$Con4 : "False");
            if (anyValueChanged) {
          ...
          watch(() => [props.modelValue, props.configurationProperties], () => {
            var _props$modelValue$Con5, _props$modelValue$Con6, _props$modelValue$Con7, _asBooleanOrNull;
            labelPrompt.value = (_props$modelValue$Con5 = props.modelValue[ConfigurationValueKey.ValuePrompt]) !== null && _props$modelValue$Con5 !== void 0 ? _props$modelValue$Con5 : "";
            definedType.value = (_props$modelValue$Con6 = props.modelValue[ConfigurationValueKey.DefinedType]) !== null && _props$modelValue$Con6 !== void 0 ? _props$modelValue$Con6 : "";
            customValues.value = (_props$modelValue$Con7 = props.modelValue[ConfigurationValueKey.CustomValues]) !== null && _props$modelValue$Con7 !== void 0 ? _props$modelValue$Con7 : "";
            internalCustomValues.value = customValues.value;
          ...
          watch(allowHtml, () => {
            ...
            return maybeUpdateConfiguration(ConfigurationValueKey.AllowHtml, (_asTrueFalseOrNull2 = asTrueFalseOrNull(allowHtml.value)) !== null && _asTrueFalseOrNull2 !== void 0 ? _asTrueFalseOrNull2 : "False");
          });
          return {
            allowHtml,
            definedType,
...
//# sourceMappingURL=valueListFieldComponents.js.map
