System.register(['@Obsidian/Utility/fieldTypes', './utils.js', 'tslib', '@Obsidian/Utility/component', './fieldType.js', '@Obsidian/Utility/booleanUtils', '@Obsidian/Utility/guid', '@Obsidian/Core/Reporting/comparisonType', '@Obsidian/Utility/numberUtils', '@Obsidian/Utility/slidingDateRange', '@Obsidian/Utility/rockDateTime', '@Obsidian/Utility/linq', '@Obsidian/Utility/stringUtils', 'vue', '@Obsidian/Core/Reporting/comparisonTypeOptions', '@Obsidian/Controls/dropDownList', '@Obsidian/Controls/fieldFilterContainer', './textFieldComponents.js', '@Obsidian/Controls/textBox', '@Obsidian/Controls/checkBox', '@Obsidian/Controls/numberBox'], (function (exports, module) {
    ...
    return {
        ...
        execute: (function () {
            ...
            const editComponent$v = defineAsyncComponent(() => __awaiter(void 0, void 0, void 0, function* () {
                return (yield module.import('./addressFieldComponents.js')).EditComponent;
            }));
            const configurationComponent$u = defineAsyncComponent(() => __awaiter(void 0, void 0, void 0, function* () {
            ...
            class CampusFieldType extends FieldTypeBase {
                ...
                doesValueMatchFilter(value, filterValue, _configurationValues) {
                    var _a;
                    const selectedValues = ((_a = filterValue.value) !== null && _a !== void 0 ? _a : "").split(",").filter(v => v !== "").map(v => v.toLowerCase());
                    ...
                    if (comparisonType === 32) {
                        return value === "";
                    }
                    else if (comparisonType === 64) {
                        return value !== "";
                    }
                    if (selectedValues.length > 0) {
                        let matched = selectedValues.includes((value !== null && value !== void 0 ? value : "").toLowerCase());
                        if (comparisonType === 16) {
                            matched = !matched;
                        }
                        return matched;
                    }
            ...
            class DateFieldType extends FieldTypeBase {
                ...
                doesValueMatchFilter(value, filterValue, configurationValues) {
                    ...
                    const valueDate = RockDateTime.parseISO(value !== null && value !== void 0 ? value : "");
                    ...
                    if (filterValue.comparisonType === 4096 && filterValueValues.length > 1) {
            ...
            class DefinedValueFieldType extends FieldTypeBase {
                ...
                doesValueMatchFilter(value, filterValue, _configurationValues) {
                    ...
                    if (comparisonType === 32) {
                        return ((_b = clientValue.value) !== null && _b !== void 0 ? _b : "") === "";
                    }
                    else if (comparisonType === 64) {
                        return ((_c = clientValue.value) !== null && _c !== void 0 ? _c : "") !== "";
                    }
                    if (selectedValues.length > 0) {
                        const userValues = ((_d = clientValue.value) !== null && _d !== void 0 ? _d : "").toLowerCase().split(",").filter(v => v !== "");
                        if (comparisonType === 8) {
                            let matchedCount = 0;
            ...
            class MultiSelectFieldType extends FieldTypeBase {
                ...
                doesValueMatchFilter(value, filterValue, _configurationValues) {
                    ...
                    if (selectedValues.length > 0) {
                        const userValues = (_b = value === null || value === void 0 ? void 0 : value.split(",").filter(v => v !== "").map(v => v.toLowerCase())) !== null && _b !== void 0 ? _b : [];
                        if (comparisonType === 8) {
                            let matchedCount = 0;
                            for (const userValue of userValues) {
                                if (selectedValues.includes(userValue)) {
            ...
            const editComponent = defineAsyncComponent(() => __awaiter(void 0, void 0, void 0, function* () {
                return (yield module.import('./valueListFieldComponents.js')).EditComponent;
            }));
            const configurationComponent = defineAsyncComponent(() => __awaiter(void 0, void 0, void 0, function* () {
                return (yield module.import('./valueListFieldComponents.js')).ConfigurationComponent;
            }));
            class ValueListFieldType extends FieldTypeBase {
                getTextValue(value, configurationValues) {
                    ...
                    try {
                        const clientValues = JSON.parse(value !== null && value !== void 0 ? value : "[]");
                        const configuredValues = JSON.parse((_a = configurationValues["values"]) !== null && _a !== void 0 ? _a : "[]");
                        const values = [];
                        for (const clientValue of clientValues) {
                            if (configuredValues.length > 0) {
                                const configuredValue = configuredValues.find(v => v.value === clientValue);
                                if (configuredValue) {
                                    values.push((_b = configuredValue.text) !== null && _b !== void 0 ? _b : "");
                                }
                            }
                            else {
            ...
            registerFieldType("7BDAE237-6E49-47AC-9961-A45AFB69E240", new ValueListFieldType());
