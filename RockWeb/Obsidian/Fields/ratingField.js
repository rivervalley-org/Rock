System.register(["vue", "../Reporting/comparisonType", "../Services/number", "./fieldType"], function (exports_1, context_1) {
    ...
    var vue_1, comparisonType_1, number_1, fieldType_1, editComponent, configurationComponent, RatingFieldType;
        ...
        execute: function () {
            ...
            RatingFieldType = class RatingFieldType extends fieldType_1.FieldTypeBase {
                getHtmlValue(value, configurationValues) {
                    ...
                    const maxRating = (_b = number_1.toNumberOrNull(configurationValues["max"])) !== null && _b !== void 0 ? _b : 5;
                    let html = "";
