System.register(["vue", "./fieldType", "./utils"], function (exports_1, context_1) {
    "use strict";
    ...
    var vue_1, fieldType_1, utils_1, editComponent, filterComponent, configurationComponent, SingleSelectFieldType;
    ...
    return {
        ...
        execute: function () {
            ...
            filterComponent = vue_1.defineAsyncComponent(() => __awaiter(void 0, void 0, void 0, function* () {
                return (yield context_1.import("./singleSelectFieldComponents")).FilterComponent;
            }));
            configurationComponent = vue_1.defineAsyncComponent(() => __awaiter(void 0, void 0, void 0, function* () {
                return (yield context_1.import("./singleSelectFieldComponents")).ConfigurationComponent;
            }));
