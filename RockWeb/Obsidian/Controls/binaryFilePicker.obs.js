System.register(['vue', '@Obsidian/Utility/component', '@Obsidian/Utility/http', './baseAsyncPicker.obs', '@Obsidian/Utility/guid'], (function (exports) {
  'use strict';
  var defineComponent, ref, computed, watch, openBlock, createBlock, unref, mergeProps, isRef, useVModelPassthrough, useStandardAsyncPickerProps, standardAsyncPickerProps, useHttp, BaseAsyncPicker, toGuidOrNull, emptyGuid;
  return {
    ...
    execute: (function () {
        ...
        setup(__props, _ref) {
          ...
          var loadOptions = function () {
            var _ref2 = _asyncToGenerator(function* () {
              var _toGuidOrNull;
              var options = {
                binaryFileTypeGuid: (_toGuidOrNull = toGuidOrNull(props.binaryFileTypeGuid)) !== null && _toGuidOrNull !== void 0 ? _toGuidOrNull : emptyGuid
              };
              var result = yield http.post("/api/v2/Controls/BinaryFilePickerGetBinaryFiles", undefined, options);
      ...
      script.__file = "Framework/Controls/binaryFilePicker.obs";

    })
  };
}));
//# sourceMappingURL=binaryFilePicker.obs.js.map
