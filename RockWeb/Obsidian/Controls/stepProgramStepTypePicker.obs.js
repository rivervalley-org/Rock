System.register(['vue', '@Obsidian/Utility/component', './stepProgramPicker.obs', './stepTypePicker.obs', './rockFormField.obs', '@Obsidian/Enums/Controls/pickerDisplayStyle', '@Obsidian/Utility/guid'], (function (exports) {
  'use strict';
  var defineComponent, computed, watch, openBlock, createBlock, unref, withCtx, isRef, createCommentVNode, useVModelPassthrough, StepProgramPicker, StepTypePicker, RockFormField, PickerDisplayStyle, toGuidOrNull;
  return {
    ...
    execute: (function () {
      ...
      var script = exports('default', defineComponent({
        name: 'stepProgramStepTypePicker',
        props: {
          modelValue: {
            type: Object,
            required: false
        ...
        setup(__props, _ref) {
          ...
          return (_ctx, _cache) => {
            return openBlock(), createBlock(unref(RockFormField), {
              ...
              }, null, 8, ["modelValue", "disabled", "displayStyle"])) : createCommentVNode("v-if", true), unref(stepProgramGuid) ? (openBlock(), createBlock(unref(StepTypePicker), {
                key: 1,
                modelValue: unref(internalValue),
      ...
      script.__file = "Framework/Controls/stepProgramStepTypePicker.obs";

    })
  };
}));
//# sourceMappingURL=stepProgramStepTypePicker.obs.js.map
