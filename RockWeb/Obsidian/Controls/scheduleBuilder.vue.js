System.register(['vue', './checkBoxList.js', './datePicker.js', './dateRangePicker.js', './dateTimePicker.js', './dropDownList.js', './modal.js', './numberBox.js', './radioButtonList.js', './rockFormField.js', './transitionVerticalCollapse.js', '@Obsidian/Utility/internetCalendar', '@Obsidian/ValidationRules', '@Obsidian/Utility/rockDateTime', '@Obsidian/Utility/component', '@Obsidian/Utility/guid', '@Obsidian/Utility/stringUtils', '@Obsidian/Utility/form', './rockLabel.js', './helpBlock.js', './javaScriptAnchor.js', '@Obsidian/Utility/numberUtils', './textBox.js', './basicTimePicker.js', 'ant-design-vue', '@Obsidian/Utility/util', './rockForm.js', './rockValidation.js', './alert.vue.js', './rockButton.js', 'tslib', '@Obsidian/Utility/promiseUtils', '@Obsidian/Utility/page'], (function (exports) {
    'use strict';
    var defineComponent, ref, shallowRef, computed, watch, pushScopeId, popScopeId, createTextVNode, createElementVNode, openBlock, createElementBlock, Fragment, createVNode, mergeProps, withCtx, withModifiers, renderList, toDisplayString, createCommentVNode, withDirectives, vModelRadio, CheckBoxList, DatePickerBase, DatePickerBase$1, DateRangePicker, DateTimePicker, DropDownList, Modal, NumberBox, RadioButtonList, RockFormField, TransitionVerticalCollapse, Calendar, Event, RecurrenceRule, containsRequiredRule, RockDateTime, standardRockFormFieldProps, useStandardRockFormFieldProps, updateRefValue, newGuid;
    return {
        setters: [function (module) {
            ...
            DatePickerBase$1 = module.DatePickerBase;
        }, function (module) {
                    ...
                    function updateValuesFromModel() {
                        ...
                        if ((event === null || event === void 0 ? void 0 : event.recurrenceDates) && event.recurrenceDates.length > 0) {
                            ...
                            const isDailyWeekday = rrule.frequency === "WEEKLY"
                                ...
                                && rrule.byDay.some(bd => bd.day === 1)
                                && rrule.byDay.some(bd => bd.day === 2)
                                && rrule.byDay.some(bd => bd.day === 3)
                                && rrule.byDay.some(bd => bd.day === 4)
                                && rrule.byDay.some(bd => bd.day === 5)
                                && rrule.interval === 1;
                            const isDailyWeekend = rrule.frequency === "WEEKLY"
                                && rrule.byDay.length === 2
                                && rrule.byDay.some(bd => bd.day === 0)
                                && rrule.byDay.some(bd => bd.day === 6)
                                && rrule.interval === 1;
                            if (isDailyWeekday) {
