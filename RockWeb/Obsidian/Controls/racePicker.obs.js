                ...
                setup(__props, { expose, emit }) {
                    ...
                    function loadOptions() {
                        ...
                        return __awaiter(this, void 0, void 0, function* () {
                            const result = yield http.post("/api/v2/Controls/RacePickerGetRaces");
                            if (result.isSuccess && result.data) {
                                loadedItems.value = (_a = result.data.races) !== null && _a !== void 0 ? _a : null;
                                label.value = (_b = result.data.label) !== null && _b !== void 0 ? _b : "Race";
