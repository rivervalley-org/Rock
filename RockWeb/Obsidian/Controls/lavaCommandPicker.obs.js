System.register(['vue', '@Obsidian/Utility/component', '@Obsidian/Utility/http', './baseAsyncPicker.obs', '@Obsidian/Enums/Controls/pickerDisplayStyle'], (function (exports) {
  'use strict';
  var defineComponent, ref, computed, openBlock, createBlock, unref, mergeProps, isRef, standardAsyncPickerProps, useVModelPassthrough, useStandardAsyncPickerProps, useHttp, BaseAsyncPicker, PickerDisplayStyle;
  return {
    ...
    execute: (function () {
        ...
        setup(__props, _ref) {
          ...
          var loadOptions = function () {
            var _ref2 = _asyncToGenerator(function* () {
              var result = yield http.post("/api/v2/Controls/LavaCommandPickerGetLavaCommands", undefined, {});
      ...
      script.__file = "Framework/Controls/lavaCommandPicker.obs";

    })
  };
}));
//# sourceMappingURL=lavaCommandPicker.obs.js.map
