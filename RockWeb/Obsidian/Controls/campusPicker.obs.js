System.register(['tslib', 'vue', '@Obsidian/Enums/Controls/pickerDisplayStyle', '@Obsidian/Utility/component', '@Obsidian/Utility/guid', '@Obsidian/Utility/http', '@Obsidian/Utility/suspense', '@Obsidian/ValidationRules', './baseAsyncPicker.js', '@Obsidian/Utility/promiseUtils', '@Obsidian/Enums/Controls/controlLazyMode', './checkBoxList.js', './rockFormField.js', '@Obsidian/Utility/form', './rockLabel.js', './helpBlock.js', './javaScriptAnchor.js', '@Obsidian/Utility/stringUtils', './dropDownList.js', 'ant-design-vue', '@Obsidian/Utility/util', './radioButtonList.js'], (function (exports) {
    'use strict';
    var __awaiter, defineComponent, ref, computed, openBlock, createBlock, mergeProps, createCommentVNode, PickerDisplayStyle, standardAsyncPickerProps, useVModelPassthrough, useStandardAsyncPickerProps, areEqual, useHttp, useSuspense, containsRequiredRule, BaseAsyncPicker;
    return {
