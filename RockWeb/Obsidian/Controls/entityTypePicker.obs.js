System.register(['vue', '@Obsidian/Utility/component', '@Obsidian/Utility/guid', '@Obsidian/Utility/http', './baseAsyncPicker.obs'], (function (exports) {
  'use strict';
  var defineComponent, ref, computed, openBlock, createBlock, unref, mergeProps, isRef, useVModelPassthrough, useStandardAsyncPickerProps, standardAsyncPickerProps, emptyGuid, useHttp, BaseAsyncPicker;
  return {
    ...
    execute: (function () {
        ...
        setup(__props, _ref) {
          ...
          var loadOptions = function () {
            var _ref2 = _asyncToGenerator(function* () {
              var options = {};
              var result = yield http.post("/api/v2/Controls/EntityTypePickerGetEntityTypes", undefined, options);
      ...
      script.__file = "Framework/Controls/entityTypePicker.obs";

    })
  };
}));
//# sourceMappingURL=entityTypePicker.obs.js.map
