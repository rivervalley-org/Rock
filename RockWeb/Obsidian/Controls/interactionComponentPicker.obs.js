System.register(['vue', '@Obsidian/Utility/component', '@Obsidian/Utility/http', './baseAsyncPicker.obs', '@Obsidian/Utility/guid'], (function (exports) {
  'use strict';
  var defineComponent, ref, computed, watch, openBlock, createBlock, unref, mergeProps, isRef, useVModelPassthrough, useStandardAsyncPickerProps, standardAsyncPickerProps, useHttp, BaseAsyncPicker, toGuidOrNull;
  return {
    ...
    execute: (function () {
        ...
        setup(__props, _ref) {
          ...
          var loadOptions = function () {
            var _ref2 = _asyncToGenerator(function* () {
              var options = {
                interactionChannelGuid: toGuidOrNull(props.interactionChannelGuid)
              };
              var result = yield http.post("/api/v2/Controls/InteractionComponentPickerGetInteractionComponents", undefined, options);
      ...
      script.__file = "Framework/Controls/interactionComponentPicker.obs";

    })
  };
}));
//# sourceMappingURL=interactionComponentPicker.obs.js.map
