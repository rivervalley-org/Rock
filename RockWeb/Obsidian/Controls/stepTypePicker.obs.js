System.register(['vue', '@Obsidian/Utility/component', '@Obsidian/Utility/http', './baseAsyncPicker.obs', '@Obsidian/Utility/guid'], (function (exports) {
  ...
  return {
    ...
    execute: (function () {
        ...
        setup(__props, _ref) {
          ...
          var loadOptions = function () {
            var _ref2 = _asyncToGenerator(function* () {
              var options = {
                stepProgramGuid: toGuidOrNull(props.stepProgramGuid)
              };
              var result = yield http.post("/api/v2/Controls/StepTypePickerGetStepTypes", undefined, options);
      ...
      script.__file = "Framework/Controls/stepTypePicker.obs";

    })
  };
}));
//# sourceMappingURL=stepTypePicker.obs.js.map
