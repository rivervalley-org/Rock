System.register(['vue', '@Obsidian/Utility/component', '@Obsidian/Utility/http', '@Obsidian/Utility/block', './baseAsyncPicker.obs', '@Obsidian/Utility/guid'], (function (exports) {
  'use strict';
  var defineComponent, ref, computed, watch, openBlock, createBlock, unref, mergeProps, isRef, useVModelPassthrough, useStandardAsyncPickerProps, standardAsyncPickerProps, useHttp, useSecurityGrantToken, BaseAsyncPicker, toGuidOrNull, areEqual, emptyGuid;
  return {
    ...
    execute: (function () {
        ...
        setup(__props, _ref) {
          ...
          var loadOptions = function () {
            var _ref2 = _asyncToGenerator(function* () {
              var workflowTypeGuid = toGuidOrNull(props.workflowTypeGuid);
              ...
              var result = yield http.post("/api/v2/Controls/WorkflowPickerGetWorkflows", undefined, options);
      ...
      script.__file = "Framework/Controls/workflowBasePicker.obs";

    })
  };
}));
//# sourceMappingURL=workflowBasePicker.obs.js.map
