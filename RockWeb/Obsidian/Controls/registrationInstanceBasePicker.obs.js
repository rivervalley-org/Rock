System.register(['vue', '@Obsidian/Utility/component', '@Obsidian/Utility/http', './baseAsyncPicker.obs', '@Obsidian/Utility/block', '@Obsidian/Utility/guid'], (function (exports) {
  'use strict';
  var defineComponent, ref, computed, watch, openBlock, createBlock, unref, mergeProps, isRef, useVModelPassthrough, useStandardAsyncPickerProps, standardAsyncPickerProps, useHttp, BaseAsyncPicker, useSecurityGrantToken, toGuidOrNull, areEqual, emptyGuid;
  return {
    ...
    execute: (function () {
      ...
      var script = exports('default', defineComponent({
        name: 'registrationInstanceBasePicker',
        ...
        setup(__props, _ref) {
          ...
          function _loadOptions() {
            _loadOptions = _asyncToGenerator(function* () {
              var registrationTemplateGuid = toGuidOrNull(props.registrationTemplateGuid);
              ...
              var result = yield http.post("/api/v2/Controls/RegistrationInstancePickerGetRegistrationInstances", null, options);
      ...
      script.__file = "Framework/Controls/registrationInstanceBasePicker.obs";

    })
  };
}));
//# sourceMappingURL=registrationInstanceBasePicker.obs.js.map
