System.register([], (function (exports) {
    ...
    return {
        execute: (function () {
            ...
            const ConnectionRequestViewModelSortProperty = {
                Requestor: 0,
                RequestorDesc: 1,
                Connector: 2,
                ConnectorDesc: 3,
            ...
            const ConnectionRequestViewModelSortPropertyDescription = {
                0: "Requestor",
                1: "Requestor Desc",
                2: "Connector",
                3: "Connector Desc",
            ...
            const ConnectionTypeViewMode = {
                List: 0,
                Board: 1
            };
            const ConnectionTypeViewModeDescription = {
                0: "List",
                1: "Board"
            };
            ...
            const ConnectionWorkflowTriggerType = {
                RequestStarted: 0,
                RequestConnected: 1,
                StatusChanged: 2,
                StateChanged: 3,
            ...
            const ConnectionWorkflowTriggerTypeDescription = {
                0: "Request Started",
                1: "Request Connected",
                2: "Status Changed",
                3: "State Changed",
            ...
            const GroupRequirementsFilter = {
                Ignore: 0,
                MustMeet: 1,
                DoesNotMeet: 2
            };
            const GroupRequirementsFilterDescription = {
                0: "Ignore",
                1: "Must Meet",
                2: "Does Not Meet"
            };
