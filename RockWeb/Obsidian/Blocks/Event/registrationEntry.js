    ...
    return {
        ...
        execute: (function () {
            ...
            function getRegistrantBasicInfo(registrant, registrantForms) {
                ...
                const firstNameGuid = ((_a = fields.find(f => f.personFieldType === 0 && f.fieldSource === 0)) === null || _a === void 0 ? void 0 : _a.guid) || "";
                const lastNameGuid = ((_b = fields.find(f => f.personFieldType === 1 && f.fieldSource === 0)) === null || _b === void 0 ? void 0 : _b.guid) || "";
                const emailGuid = ((_c = fields.find(f => f.personFieldType === 4 && f.fieldSource === 0)) === null || _c === void 0 ? void 0 : _c.guid) || "";
                return {
...
`
            ...
            function isRuleMet(rule, fieldValues, formFields) {
                ...
                if (!((_a = comparedToFormField === null || comparedToFormField === void 0 ? void 0 : comparedToFormField.attribute) === null || _a === void 0 ? void 0 : _a.fieldTypeGuid)) {
                    return false;
                }
                ...
                return fieldType.doesValueMatchFilter(value, rule.comparisonValue, (_b = comparedToFormField.attribute.configurationValues) !== null && _b !== void 0 ? _b : {});
            }
            var RegistrantAttributeField = defineComponent({
                ...
                setup(props) {
                    ...
                    const modifiedAttribute = computed(() => {
                        ...
                        const fieldAttribute = Object.assign({}, props.field.attribute);
                        ...
                        return __awaiter(this, void 0, void 0, function* () {
                            ...
                            try {
                                const result = yield this.invokeBlockAction("CheckDiscountCode", {
                                    ...
                                    registrationGuid: (_a = this.registrationEntryState.viewModel.session) === null || _a === void 0 ? void 0 : _a.registrationGuid
                                });
                                if (result.isError || !result.data) {
