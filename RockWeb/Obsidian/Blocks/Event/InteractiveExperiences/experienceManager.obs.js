System.register(['tslib', 'vue', '@Obsidian/Controls/alert.obs', '@Obsidian/Controls/dropDownList', '@Obsidian/Controls/kpi.obs', '@Obsidian/Utility/component', '@Obsidian/Controls/inlineCheckBox', '@Obsidian/Controls/rockLabel', '@Obsidian/Enums/Event/interactiveExperienceApprovalStatus', '@Obsidian/Utility/block', '@Obsidian/Utility/guid', '@Obsidian/Controls/campusPicker.obs', '@Obsidian/Utility/dialogs', '@Obsidian/Controls/checkBoxList', '@Obsidian/Controls/panel', '@Obsidian/Utility/realTime'], (function (exports) {
    'use strict';
    var __awaiter, defineComponent, openBlock, createElementBlock, Fragment, renderList, normalizeClass, withModifiers, createElementVNode, toDisplayString, ref, computed, watch, createTextVNode, pushScopeId, popScopeId, createVNode, createBlock, withCtx, createCommentVNode, reactive, provide, createSlots, withDirectives, vShow, Alert, DropDownList, Kpi, useVModelPassthrough, InlineCheckBox, RockLabel, InteractiveExperienceApprovalStatus, useInvokeBlockAction, useConfigurationValues, onConfigurationValuesChanged, useReloadBlock, areEqual, CampusPicker, alert, confirm, CheckBoxList, Panel, getTopic;
    return {
        ...
        execute: (function () {
            ...
            __sfc_style$2.textContent = `.action-item[data-v-wbfid0pcysgxq7omicoznltf] {
    display: flex;
    align-items: stretch;
    margin-bottom: 12px;
    cursor: pointer;
}
.action-item > *[data-v-wbfid0pcysgxq7omicoznltf] {
    display: flex;
    align-items: center;
    align-self: stretch;
    padding: 12px;
...
.action-item > *[data-v-wbfid0pcysgxq7omicoznltf]:first-child {
...
.action-item > *[data-v-wbfid0pcysgxq7omicoznltf]:last-child {
    padding-right: 16px;
    border-right: 1px solid #c4c4c4;
    border-radius: 0 8px 8px 0;
}
.action-item > .action-item-icon[data-v-wbfid0pcysgxq7omicoznltf],
.action-item > .action-item-selected-icon[data-v-wbfid0pcysgxq7omicoznltf] {
    color: #777;
}
.action-item > .action-item-icon > .icon[data-v-wbfid0pcysgxq7omicoznltf] {
    margin-left: 8px;
}
.action-item > .action-item-content[data-v-wbfid0pcysgxq7omicoznltf] {
    flex: 1 0;
}
.action-item:hover > *[data-v-wbfid0pcysgxq7omicoznltf] {
    background-color: rgba(85, 150, 230, .1);
}
.action-item.selected > *[data-v-wbfid0pcysgxq7omicoznltf] {
    color: #0079b0;
    background-color: #d9f2fe;
    border-color: #009ce3;
}
.action-item.selected > .action-item-selected-icon[data-v-wbfid0pcysgxq7omicoznltf] {
    color: #009ce3;
}`;
            document.head.appendChild(__sfc_style$2);
            const exportHelper$5 = _sfc_main$5;
            for (const [key, val] of [["render", render$5], ["__scopeId", "data-v-wbfid0pcysgxq7omicoznltf"]]) {
            ...
            const _withScopeId = n => (pushScopeId("data-v-jz6fp060n5r540tys8k1auod"), n = n(), popScopeId(), n);
            ...
            __sfc_style$1.textContent = `.experience-body.inactive[data-v-jz6fp060n5r540tys8k1auod] {
    cursor: not-allowed;
    opacity: .5;
    pointer-events: none;
}
.experience-actions-panel[data-v-jz6fp060n5r540tys8k1auod] {
    background-color: var(--panel-heading-bg);
}
.preview-panel[data-v-jz6fp060n5r540tys8k1auod] {
    display: flex;
    flex-direction: column;
    min-height: 480px;
}
.preview-panel iframe[data-v-jz6fp060n5r540tys8k1auod] {
    flex-grow: 1;
    overflow: hidden;
    ...
    border-radius: 4px;
            ...
            for (const [key, val] of [["render", render$4], ["__scopeId", "data-v-jz6fp060n5r540tys8k1auod"]]) {
            ...
            __sfc_style.textContent = `.panel-navigation-bar[data-v-d3xf1ju3dp80d00aqnz6626n] {
    overflow-x: clip;
    background-color: var(--panel-bg);
}`;
            document.head.appendChild(__sfc_style);
            const exportHelper$1 = _sfc_main$1;
            for (const [key, val] of [["render", render$1], ["__scopeId", "data-v-d3xf1ju3dp80d00aqnz6626n"]]) {
