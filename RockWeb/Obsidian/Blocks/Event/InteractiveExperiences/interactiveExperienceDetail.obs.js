System.register(['tslib', 'vue', '@Obsidian/Controls/alert.obs', '@Obsidian/SystemGuids/entityType', '@Obsidian/Templates/detailBlock', '@Obsidian/Enums/Controls/detailPanelMode', '@Obsidian/Controls/attributeValuesContainer', '@Obsidian/Controls/checkBox', '@Obsidian/Controls/dropDownList', '@Obsidian/Controls/modal', '@Obsidian/Controls/panel', '@Obsidian/Controls/sectionHeader', '@Obsidian/Directives/dragDrop', '@Obsidian/Utility/component', '@Obsidian/Utility/block', '@Obsidian/Utility/guid', '@Obsidian/Utility/dialogs', '@Obsidian/Controls/campusPicker.obs', '@Obsidian/Controls/codeEditor', '@Obsidian/Controls/colorPicker', '@Obsidian/Controls/dataViewPicker', '@Obsidian/Controls/imageUploader', '@Obsidian/Controls/groupPicker', '@Obsidian/Controls/radioButtonList', '@Obsidian/Controls/scheduleBuilder.obs', '@Obsidian/Controls/sectionContainer', '@Obsidian/Controls/textBox', '@Obsidian/Controls/transitionVerticalCollapse', '@Obsidian/SystemGuids/binaryFiletype', '@Obsidian/Utility/numberUtils', '@Obsidian/Enums/Event/interactiveExperiencePushNotificationType', '@Obsidian/Utility/internetCalendar', '@Obsidian/Enums/Event/interactiveExperienceCampusBehavior', '@Obsidian/Controls/valueDetailList', '@Obsidian/Core/Controls/valueDetailListItemBuilder', '@Obsidian/Utility/stringUtils', '@Obsidian/Utility/util'], (function (exports) {
    ...
    return {
        ...
        execute: (function () {
            ...
            const _withScopeId = n => (pushScopeId("data-v-6u59i24ruy3k8kpep8fn5f6j"), n = n(), popScopeId(), n);
            ...
            __sfc_style.textContent = `.action-item[data-v-6u59i24ruy3k8kpep8fn5f6j] {
    display: flex;
    align-items: stretch;
    margin-bottom: 12px;
    overflow: hidden;
...
.action-item-count[data-v-6u59i24ruy3k8kpep8fn5f6j] {
    display: flex;
    align-items: center;
...
.action-item-body[data-v-6u59i24ruy3k8kpep8fn5f6j] {
    display: flex;
    flex: 1 0 0;
    align-items: center;
    padding: 8px 0;
...
.action-item-body > *[data-v-6u59i24ruy3k8kpep8fn5f6j]:last-child {
    display: block;
    padding-right: 16px;
}
.action-item .action-item-icon[data-v-6u59i24ruy3k8kpep8fn5f6j] {
    display: flex;
    align-items: center;
    justify-content: center;
    width: 36px;
...
.action-item .action-item-content[data-v-6u59i24ruy3k8kpep8fn5f6j] {
    flex: 1 0;
    flex-direction: column;
    align-items: flex-start;
    justify-content: center;
}
.action-item .reorder-handle[data-v-6u59i24ruy3k8kpep8fn5f6j] {
    cursor: grab;
}
.action-item .action-columncommand[data-v-6u59i24ruy3k8kpep8fn5f6j] {
    visibility: hidden;
    opacity: 0;
    transition: opacity .2s ease-in-out;
}
.action-item .title[data-v-6u59i24ruy3k8kpep8fn5f6j] {
    font-weight: 600;
}
.action-item:hover .action-columncommand[data-v-6u59i24ruy3k8kpep8fn5f6j] {
    visibility: visible;
    opacity: 1;
}`;
            document.head.appendChild(__sfc_style);
            const exportHelper$3 = _sfc_main$3;
            for (const [key, val] of [["render", render$3], ["__scopeId", "data-v-6u59i24ruy3k8kpep8fn5f6j"]]) {
