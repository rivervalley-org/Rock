System.register(['tslib', 'vue', '@Obsidian/Controls/alert.vue', '@Obsidian/Controls/rockButton', '@Obsidian/Controls/radioButtonList', '@Obsidian/Utility/realTime', '@Obsidian/Utility/block'], (function (exports) {
    'use strict';
    var __awaiter, defineComponent, ref, computed, watch, createTextVNode, openBlock, createElementBlock, normalizeClass, createElementVNode, toDisplayString, withDirectives, vModelText, createBlock, withCtx, createCommentVNode, createVNode, normalizeStyle, resolveDynamicComponent, Alert, RockButton, BtnType, RadioButtonList, getTopic, useConfigurationValues, onConfigurationValuesChanged, useReloadBlock;
    return {
    ...
    margin-top: 18px;
            ...
            const _sfc_main$1 = defineComponent({
                ...
                setup(__props, { expose }) {
                    ...
                    const __returned__ = { props, answerText, isAnswerSubmitted, errorMessage, answerItems, additionalActionClasses, questionText, isButtonDisabled, onSubmitClick, Alert, RockButton, BtnType, RadioButtonList };
                    Object.defineProperty(__returned__, '__isScriptSetup', { enumerable: false, value: true });
                    return __returned__;
                }
            });
                    ...
                    function startRealTime() {
                        ...
                        return __awaiter(this, void 0, void 0, function* () {
                            ...
                            topic.onReconnect((server) => __awaiter(this, void 0, void 0, function* () {
                                var _b;
                                const response = yield server.joinExperience(experienceToken);
                                eventId.value = (_b = response.occurrenceIdKey) !== null && _b !== void 0 ? _b : null;
