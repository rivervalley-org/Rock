System.register(['tslib', 'vue', '@Obsidian/Controls/alert.vue', '@Obsidian/Templates/detailBlock', '@Obsidian/Controls/attributeValuesContainer', '@Obsidian/Controls/checkBox', '@Obsidian/Controls/dropDownList', '@Obsidian/Controls/modal', '@Obsidian/Controls/panel', '@Obsidian/Controls/sectionHeader', '@Obsidian/Directives/dragDrop', '@Obsidian/Utility/component', '@Obsidian/Utility/block', '@Obsidian/Utility/guid', '@Obsidian/Utility/dialogs', '@Obsidian/Controls/campusPicker.vue', '@Obsidian/Controls/codeEditor', '@Obsidian/Controls/colorPicker', '@Obsidian/Controls/dataViewPicker', '@Obsidian/Controls/imageUploader', '@Obsidian/Controls/groupPicker', '@Obsidian/Controls/radioButtonList', '@Obsidian/Controls/scheduleBuilder.vue', '@Obsidian/Controls/sectionContainer', '@Obsidian/Controls/textBox', '@Obsidian/Controls/transitionVerticalCollapse', '@Obsidian/Utility/numberUtils', '@Obsidian/Utility/internetCalendar', '@Obsidian/Controls/valueDetailList', '@Obsidian/Core/Controls/valueDetailListItemBuilder', '@Obsidian/Utility/stringUtils', '@Obsidian/Utility/util'], (function (exports) {
    ...
    return {
        ...
        execute: (function () {
            ...
            const _withScopeId = n => (pushScopeId("data-v-pxzcm99jy7uoorczi5ifn70y"), n = n(), popScopeId(), n);
            ...
            __sfc_style.textContent = `.action-item[data-v-pxzcm99jy7uoorczi5ifn70y] {
    display: flex;
    align-items: stretch;
    margin-bottom: 12px;
    overflow: hidden;
...
.action-item-count[data-v-pxzcm99jy7uoorczi5ifn70y] {
    display: flex;
    align-items: center;
...
.action-item-body[data-v-pxzcm99jy7uoorczi5ifn70y] {
    display: flex;
    flex: 1 0 0;
    align-items: center;
    padding: 8px 0;
...
.action-item-body > *[data-v-pxzcm99jy7uoorczi5ifn70y]:last-child {
    display: block;
    padding-right: 16px;
}
.action-item .action-item-icon[data-v-pxzcm99jy7uoorczi5ifn70y] {
    display: flex;
    align-items: center;
    justify-content: center;
    width: 36px;
...
.action-item .action-item-content[data-v-pxzcm99jy7uoorczi5ifn70y] {
    flex: 1 0;
    flex-direction: column;
    align-items: flex-start;
    justify-content: center;
}
.action-item .reorder-handle[data-v-pxzcm99jy7uoorczi5ifn70y] {
    cursor: grab;
}
.action-item .action-columncommand[data-v-pxzcm99jy7uoorczi5ifn70y] {
    visibility: hidden;
    opacity: 0;
    transition: opacity .2s ease-in-out;
}
.action-item .title[data-v-pxzcm99jy7uoorczi5ifn70y] {
    font-weight: 600;
}
.action-item:hover .action-columncommand[data-v-pxzcm99jy7uoorczi5ifn70y] {
    visibility: visible;
    opacity: 1;
}`;
            document.head.appendChild(__sfc_style);
            const exportHelper$3 = _sfc_main$3;
            for (const [key, val] of [["render", render$3], ["__scopeId", "data-v-pxzcm99jy7uoorczi5ifn70y"]]) {
