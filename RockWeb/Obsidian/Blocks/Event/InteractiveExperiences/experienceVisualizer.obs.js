        ...
        execute: (function () {
            ...
            const _sfc_main$2 = defineComponent({
                ...
                setup(__props, { expose }) {
                    expose();
                    const props = __props;
                    const canvasElement = shallowRef(null);
    ...
    flex-grow: 1;
            ...
            const _sfc_main = defineComponent({
                ...
                setup(__props, { expose }) {
                    ...
                    let checkForNewOccurrenceTimeout = null;
                    ...
                    function joinExperience(token) {
                        ...
                        return __awaiter(this, void 0, void 0, function* () {
                            ...
                            try {
                                ...
                                const response = yield realTimeTopic.server.joinExperience(token);
