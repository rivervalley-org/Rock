System.register(['tslib', '@Obsidian/Utility/block', 'vue', '@Obsidian/Controls/alert.vue', '@Obsidian/Controls/rockButton', '@Obsidian/Templates/block', '@Obsidian/Controls/sectionHeader', '@Obsidian/Controls/rockForm', '@Obsidian/Controls/slidingDateRangePicker', '@Obsidian/Controls/numberBox', '@Obsidian/Controls/dropDownList', '@Obsidian/Utility/numberUtils', '@Obsidian/Utility/guid', '@Obsidian/Utility/url'], (function (exports) {
    'use strict';
            ...
            var FlowNodeDiagram = defineComponent({
                ...
                setup(props) {
                    ...
                    const nodeHorizontalSpacing = computed(() => {
                        const flowSpace = settings.value.chartWidth - (settings.value.nodeWidth * levelsCount.value) - 24;
