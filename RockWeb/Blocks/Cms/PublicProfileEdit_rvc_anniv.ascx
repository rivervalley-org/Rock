<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PublicProfileEdit_rvc_anniv.ascx.cs" Inherits="RockWeb.Blocks.Cms.PublicProfileEdit_rvc_anniv" %>
                ...
                <asp:Panel ID="pnlEdit" runat="server">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            ...
                            <%-- RVC Custom - Anniversary Picker added --%>
