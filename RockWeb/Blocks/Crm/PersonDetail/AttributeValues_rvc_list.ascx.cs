...
namespace RockWeb.Blocks.Crm.PersonDetail
{
    ...
    /// </summary>
    [DisplayName( "Attribute Values RVC List" )]
    [Category( "CRM > Person Detail" )]
    [Description( "Allows for editing the value(s) of a set of attributes for person." )]
    /// <summary>
    /// User control for Edit or List
    /// </summary>
    [TextField("BlockProcess", "Type in either EDIT or LIST (All CAPS)")]
    ...
    public partial class AttributeValues_rvc_list : PersonBlock
    {
...
";
        ...
        protected override void OnLoad( EventArgs e )
        {
            ...
            if (!Page.IsPostBack)
            {
                // RVC Code Start - enables the edit display format
                ViewMode = VIEW_MODE_EDIT;
                // RVC Code End

                BindData();
                // RVC Code Start - disabled the save/edit actions
                string blockPurpose = GetAttributeValue("BlockProcess");
                if (blockPurpose == "LIST")
                {
