<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DefinedTypeList_rvc.ascx.cs" Inherits="RockWeb.Blocks.Core.DefinedTypeList_rvc" %>
    ...
    <ContentTemplate>
        ...
        <div class="panel panel-block">
            <div class="panel-heading">
                <h1 class="panel-title"><i class="fa fa-book"></i> Defined Types List - Modified</h1>
            </div>
            <div class="panel-body">
                <div class="grid grid-panel">
                    <Rock:GridFilter ID="tFilter" runat="server" Visible="false">
