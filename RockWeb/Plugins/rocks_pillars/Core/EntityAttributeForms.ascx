<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EntityAttributeForms.ascx.cs" Inherits="RockWeb.Plugins.rocks_pillars.Core.EntityAttributeForms" %>
...
<asp:UpdatePanel ID="upnlContent" runat="server" ChildrenAsTriggers="false" UpdateMode="Conditional">
    <ContentTemplate>
        ...
        <asp:Panel ID="pnlEditModal" runat="server" Visible="false" CssClass="panel panel-block">
            <Rock:ModalDialog ID="mdEdit" runat="server" OnSaveClick="btnSave_Click" Title="Entity Attribute Forms Configuration" OnCancelScript="">
                <Content>
                        ...
                        <ContentTemplate>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="well">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <Rock:RockLiteral ID="lEntityType" runat="server" Label="Entity Type" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <Rock:RockTextBox ID="tbEntityTypeQualifierColumn" runat="server" Label="Qualifier Column Name" />
                                        </div>
                                        <div class="col-md-6">
                                            <Rock:RockTextBox ID="tbEntityTypeQualifierValue" runat="server" Label="Qualifier Value" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <Rock:WorkflowTypePicker ID="wtpWorkflow" runat="server" Label="Workflow"
                                            Help="An optional workflow to launch after the entity has filled out all of the forms." />
                                        <Rock:RockTextBox  ID="tbDoneUrl" runat="server" Label="Done Url" TextMode="MultiLine" Rows="3"
                                            Help="An optional URL to redirect user to after they have finished entering information on all the forms. This supports Lava and the 'Entity' is an available merge field." />
                                    </div>
                                </div>
        ...
        <Rock:ModalDialog ID="dlgField" runat="server" Title="Form Field" OnSaveClick="dlgField_SaveClick" OnCancelScript="clearActiveDialog();" ValidationGroup="Field">
            <Content>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <Rock:RockDropDownList ID="ddlEntityAttributes" runat="server" Label="Entity Attribute" ValidationGroup="Field" />
                    </div>
                    <div class="col-md-4">
                        <Rock:RockCheckBox ID="cbUseEntityCurrentValue" runat="server" Label="Use Current Value" Text="Yes" ValidationGroup="Field"
                            Help="Should the entity's current value for this field be displayed (pre-filled)?" />
                    </div>
                    <div class="col-md-4">
