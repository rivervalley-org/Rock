<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PrayerCardRecordGenerator.ascx.cs" Inherits="RockWeb.Plugins.org_rivervalley.PrayerCards.PrayerCardRecordGenerator" %>
...
<asp:UpdatePanel ID="upnlContent" runat="server">
    <ContentTemplate>
        ...
        <asp:Panel ID="pnlSingleCampusDetail" runat="server" CssClass="panel panel-block" Visible="false">            
            <div class="panel-heading">
                <h1 class="panel-title">
                    Prayer Card - Single Campus 
                </h1>
            </div>    
            <div class="panel-body">
                <div class="row">                          
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <Rock:DatePicker ID="dtPickerSingle" runat="server" Label="Start Date"  DatePickerType="Date" Required="true" />
                    </div>                            
                </div
                
                <div class="actions">
                    <p></p>
                    <asp:LinkButton ID="btnSingleCampusDetail" runat="server" Text="Continue" CssClass="btn btn-primary" OnClick="btnSingleCampusDetail_Click" CausesValidation="false" />
                    <asp:LinkButton ID="btnSingleCampusDetailCancel" runat="server" Text="Cancel" CssClass="btn btn-link" CausesValidation="false" OnClick="btnDetailCancel_Click" />
                </div>
