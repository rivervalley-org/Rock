<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PrayerCardGeneratorTest.ascx.cs" Inherits="RockWeb.Plugins.org_rivervalley.PrayerCards.Sandbox.PrayerCardGeneratorTest" %>
