<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PrayerCardRecordSelection.ascx.cs" Inherits="RockWeb.Plugins.org_rivervalley.PrayerCards.PrayerCardRecordSelection" %>
