...
{
    [DisplayName("Prayer Cards Test Two")]
    [Category("org_rivervalley > PrayerCards")]
    [Description("Prayer Cards Testing ")]

    public partial class PrayerCardsTestTwo : Rock.Web.UI.RockBlock
    {
        #region Fields

        // Test field
        private bool saveAttributes = false;
        private bool saveDataRecord = false;
        ...
        private void ProcessNetworkChurches(int count)
        {
            ...
            while (rdr.Read())
            {
                ...
                var definedValueNC = new DefinedValueService(new RockContext()).Get(5683);
        ...
        private void ProcessLocalChurches(int count)
        {
            ...
            while (rdr.Read())
            {
                ...
                var definedValueLC = new DefinedValueService(new RockContext()).Get(6394);
        ...
        private void ProcessMinistryLeaders(int count)
        {
            ...
            while (rdr.Read())
            {
                ...
                var definedValueML = new DefinedValueService(new RockContext()).Get(6553);
        ...
        private void ProcessPoliticalLeaders(int count)
        {
            ...
            while (rdr.Read())
            {
                ...
                var definedValuePL = new DefinedValueService(new RockContext()).Get(6426);
        ...
        private void ProcessMissionaries(int count)
        {
            ...
            while (rdr.Read())
            {
                ...
                var definedValueMS = new DefinedValueService(new RockContext()).Get(6323);
        ...
        protected void ProcessVirtues(int count)
        {
            ...
            while (rdr.Read())
            {
                ...
                var definedValueVR = new DefinedValueService(new RockContext()).Get(6164);
        ...
        private void ProcessLifeGroups(int count)
        {
            ...
            while (rdr.Read())
            {
                ...
                lifeGroup = new GroupService(rockContext).Get(66637);
