<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PrayerCardsReportByCampus.ascx.cs" Inherits="RockWeb.Plugins.org_rivervalley.PrayerCards.PrayerCardsReportByCampus" %>
    ...
    <ContentTemplate>
        ...
        <asp:Panel ID="pnlComplete" runat="server" CssClass="panel panel-block" Visible="false">            
            <div class="panel-body">
                <div class="row">
                    <div class="col-sm-12">
                        <b><asp:Literal ID="lReportHeader" runat="server" />
                    </div>        
                </div>
                <div class="row">
                    <div class="col-sm-12">
