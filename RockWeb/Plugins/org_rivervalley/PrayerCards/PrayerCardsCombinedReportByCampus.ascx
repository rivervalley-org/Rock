<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PrayerCardsCombinedReportByCampus.ascx.cs" Inherits="RockWeb.Plugins.org_rivervalley.PrayerCards.PrayerCardsCombinedReportByCampus" %>
    ...
    <ContentTemplate>
        ...
        <asp:Panel ID="pnlComplete" runat="server" CssClass="panel panel-block" Visible="false">            
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <asp:Literal ID="lFamilies" runat="server" />
                    </div>        
                </div>
