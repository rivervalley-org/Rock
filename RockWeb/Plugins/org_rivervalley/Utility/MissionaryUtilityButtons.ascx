        ...
        <asp:Panel ID="pnlButtons" runat="server" CssClass="panel panel-block" Visible="true">
            ...
            <div class="panel-body">        
                ...
                <div class="actions">
                    ...
                    <br><br><asp:LinkButton ID="btnAddMissionary" runat="server" Text="Add to Missionary Group" CssClass="btn btn-primary" OnClick="btnAddMissionary_Click" CausesValidation="false" ToolTip="Clicking this button adds the missionary to the Missionary Group" />
                    <asp:LinkButton ID="btnAddContribution" runat="server" Text="Add to Missionary Giving Report" CssClass="btn btn-primary" OnClick="btnAddContribution_Click" CausesValidation="false" ToolTip="Clicking this button adds the missionary to the Online Contribution Receipt for Missionary Group" />
                </div>
            </div>
        </asp:Panel>
