...
namespace RockWeb.Plugins.org_rivervalley.GroupScheduling
{
    /* Custom Changes
        - Group picker is hidden
        - Group picker is populated by page parameter "GroupId"
        - Child groups checkbox is preselected and hidden
        - Locations checkbox is preselected and hidden
    ...
    */
    ...
    [Category( "River Valley > Group Scheduling" )]
    ...
    public partial class GroupScheduleCommunication : RockBlock
    {
        ...
        private void ShowDetails()
        {
            ...
            if ( groupId.HasValue )
            {
                gpGroups.SetValue( groupId.Value );
                nbCommunicationWarning.Visible = false;
            }
            else
            {
                nbCommunicationWarning.Text = "No group is found.";
                nbCommunicationWarning.Visible = true;
                btnCreateCommunication.Visible = false;
            }
        ...
        private void UpdateLocationListFromSelectedSchedules()
        {
            ...
            cblLocations.Visible = false; // Custom
            ...
            foreach ( var location in locationList )
            {
                ...
                locationListItem.Selected = true; // Custom
