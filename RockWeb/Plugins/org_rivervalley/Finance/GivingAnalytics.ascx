<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GivingAnalytics.ascx.cs" Inherits="RockWeb.Plugins.org_riverValley.Finance.GivingAnalytics" %>
...
<style>
    ...
    .panel-summary .panel-body > .row > [class*="col-"]:first-child {
        padding-top: 0px;
        padding-bottom: 0px;
    }
</style>
                            ...
                            <asp:Panel ID="pnlDetails" runat="server">
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-md-offset-8 margin-t-md">
                                        <asp:Panel ID="pnlSummary" runat="server" CssClass="panel panel-block panel-summary">
                                            <div class="panel-heading">
                                                <h1 class="panel-title">Account Summary</h1>
                                            </div>
                                            <div class="panel-body">
                                                <Rock:Grid ID="gAccountSummary" ShowHeader="false" runat="server" EmptyDataText="No Account Details" RowItemText="Account" 
                                                    DisplayType="Light" ExportSource="ColumnOutput" ExportFilename="Account Summary" >
                                                    <Columns>
                                                        <Rock:RockBoundField DataField="Name" HeaderText="Account" HtmlEncode="false" />
                                                        <Rock:CurrencyField  DataField="TotalAmount" HeaderText="Amount" ItemStyle-HorizontalAlign="Right" />
                                                    </Columns>
                                                </Rock:Grid>
                                            </div>
                                        </asp:Panel>
