<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ScheduledTransactionEdit.ascx.cs" Inherits="RockWeb.Plugins.org_riverValley.Finance.ScheduledTransactionEdit" %>
