<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GroupRegistration.ascx.cs" Inherits="RockWeb.Plugins.org_riverValley.Groups.GroupRegistration" %>
        ...
        <asp:Panel ID="pnlView" runat="server">
            ...
            <div class="row">
                ...
                <asp:Panel ID="pnlCol2" runat="server" CssClass="col-md-6">
                    ...
                    <Rock:BirthdayPicker ID="bpSpouseBirthdate" runat="server" Label="Spouse Birthdate" />
                </asp:Panel>
