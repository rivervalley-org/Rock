<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GroupFinder.ascx.cs" Inherits="RockWeb.Plugins.org_riverValley.Groups.GroupFinder" %>
        ...
        <asp:Panel ID="pnlView" runat="server" CssClass="panel panel-block">
            ...
            <div class="panel-body">
                ...
                <asp:Panel ID="pnlSearch" runat="server">
                    ...
                    <Rock:RockTextBox ID="tbKeyword" runat="server" Label="Keyword" />
