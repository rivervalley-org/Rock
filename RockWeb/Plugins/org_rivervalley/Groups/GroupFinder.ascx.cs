...
namespace RockWeb.Plugins.org_riverValley.Groups
{
    ...
    /// 
    /// RVC Custom Features: Added keyword search
    /// </summary>
...
", "CustomSetting" )]
    ...
    public partial class GroupFinder : RockBlockCustomSettings
    {
        ...
        private void ShowResults()
        {
            ...
            // RVC Custom - Filter query by a keyword
            if ( tbKeyword.Text.IsNotNullOrWhiteSpace() )
            {
                groupQry = groupQry.Where( g => g.Name.Contains( tbKeyword.Text ) ||
                                                g.Description.Contains( tbKeyword.Text ) );
            }
