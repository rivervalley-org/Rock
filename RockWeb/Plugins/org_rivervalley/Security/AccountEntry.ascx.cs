...
namespace RockWeb.Plugins.org_riverValley.Security
{
    /// <summary>
    /// Block for user to create a new login account.
    /// </summary>
    [DisplayName( "Account Entry" )]
    [Category( "River Valley > Security" )]
    ...
    [BooleanField( "Gender Required", "Should Gender be required.", false, order: 16 )]
    [BooleanField( "Show Phone Numbers", "Allows hiding the phone numbers.", false, order: 17 )]
    [BooleanField( "Show Campus", "Should a campus field be displayed for user to select from?", false, "", 18)]
    [BooleanField( "Campus Required", "Should campus be required?", true, "", 19 )]
    [IntegerField( "Minimum Age", "The minimum age allowed to create an account. Warning: The Children's Online Privacy Protection Act disallows children under the age of 13 from giving out personal information without their parents' permission.", false, 13, order: 20 )]
    [DefinedValueField( Rock.SystemGuid.DefinedType.PERSON_PHONE_TYPE, "Phone Types", "The phone numbers to display for editing.", false, true, order: 21 )]
    [DefinedValueField( Rock.SystemGuid.DefinedType.PERSON_PHONE_TYPE, "Phone Types Required", "The phone numbers that are required.", false, true, order: 22 )]
    public partial class AccountEntry : Rock.Web.UI.RockBlock
    {
        ...
        protected override void OnLoad( System.EventArgs e )
        {
            ...
            if ( !Page.IsPostBack )
            {
                ...
                // show/hide fields
                ddlGender.Required = GetAttributeValue( "GenderRequired" ).AsBoolean( false );
                cpCampus.Visible = GetAttributeValue( "ShowCampus" ).AsBoolean();
                cpCampus.Required = GetAttributeValue( "CampusRequired" ).AsBoolean( false );
