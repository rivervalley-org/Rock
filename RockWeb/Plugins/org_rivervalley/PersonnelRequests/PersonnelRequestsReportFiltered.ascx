<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PersonnelRequestsReportFiltered.ascx.cs" Inherits="RockWeb.Plugins.org_rivervalley.PersonnelRequests.PersonnelRequestsReportFiltered" %>
...
<asp:Panel ID="pnl_header" CssClass="panel panel-block" runat="server">
    <div class="panel-heading">
        <h3>Personnel Request Report Filtered</h3>
