...
namespace Rockweb.Plugins.com_centralaz.SpiritualGifts
{
    ...
    public partial class SpiritualGiftResult : Rock.Web.UI.RockBlock
    {
        ...
        private void ShowResults(Person person)
        {
            ...
            SpiritualGiftService.PlotOneGraph(giftScore_Administration, giftScore_Craftsmanship, giftScore_CreativeCommunication, giftScore_EncouragementExhortation, giftScore_Evangelism, giftScore_HelpsService, giftScore_Hospitality, giftScore_Intercession, giftScore_Leadership, giftScore_Mercy, giftScore_Pastoring, giftScore_Teaching,
                savedScores.Administration, savedScores.Craftsmanship, savedScores.CreativeCommunication, savedScores.EncouragementExhortation, savedScores.Evangelism, savedScores.HelpsService, savedScores.Hospitality, savedScores.Intercession, savedScores.Leadership, savedScores.Mercy,savedScores.Pastoring, savedScores.Teaching, 36);
