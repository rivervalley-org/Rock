        ...
        <asp:Panel ID="pnlResults" runat="server" CssClass="panel panel-block" Visible="false">
            ...
            <div class="panel-body">
                ...
                <ul class="spiritualchart" style="text-align: center">
                    ...
                    <li id="giftScore_Craftsmanship" runat="server" class="spiritualbar">
                        <div class="spiritualbar-label" style="text-transform: initial; font-size: 19px">Craftmanship</div>
                    </li>
                    <li id="giftScore_CreativeCommunication" runat="server" class="spiritualbar">
                        <div class="spiritualbar-label" style="text-transform: initial; font-size: 19px">Creative Communication</div>
                    </li>
                    ...
                    <li id="giftScore_EncouragementExhortation" runat="server" class="spiritualbar">
                        <div class="spiritualbar-label" style="text-transform: initial; font-size: 17px">Encouragement Exhortation</div>
                    </li>
                    <li id="giftScore_Administration" runat="server" class="spiritualbar">
                        <div class="spiritualbar-label" style="text-transform: initial; font-size: 19px">Administration</div>
                    </li>
                    ...
                    <li id="giftScore_Intercession" runat="server" class="spiritualbar">
                        <div class="spiritualbar-label" style="text-transform: initial; font-size: 19px">Intercession</div>
                    </li>
                    <li id="giftScore_Hospitality" runat="server" class="spiritualbar">
                        <div class="spiritualbar-label" style="text-transform: initial; font-size: 19px">Hospitality</div>
                    </li>
                    <li id="giftScore_HelpsService" runat="server" class="spiritualbar">
                        <div class="spiritualbar-label" style="text-transform: initial; font-size: 19px">Helps Service</div>
                    </li>
                    <li id="giftScore_Pastoring" runat="server" class="spiritualbar">
                        <div class="spiritualbar-label" style="text-transform: initial; font-size: 19px">Pastoring</div>
                    </li>
                    <li id="giftScore_Evangelism" runat="server" class="spiritualbar">
                        <div class="spiritualbar-label" style="text-transform: initial; font-size: 19px">Evangelism</div>
                    </li>
                </ul>
