...
namespace org.rivervalley.Jobs
{
    ...
    /// </summary>
    [DisplayName( "RVC Expiring Credit Card Notices" )]
    ...
    public class SendCreditCardExpirationNotices : RockJob
    {
        ...
        private RemoveExpiredSavedAccountsResult RemoveExpiredSavedAccounts()
        {
            ...
            return RemoveExpiredSavedAccounts( removedExpiredSavedAccountDays.Value );
        }
        ...
        private SendExpiredCreditCardNoticesResult SendExpiredCreditCardNotices()
        {
            ...
            var financialScheduledTransactionQuery = new FinancialScheduledTransactionService( rockContext ).Queryable()
                .Where( t => t.IsActive &&
                (t.FinancialPaymentDetail.CardExpirationDate != null ||
                    (t.FinancialPaymentDetail.FinancialPersonSavedAccount != null &&
                     t.FinancialPaymentDetail.FinancialPersonSavedAccount.FinancialPaymentDetail.CardExpirationDate != null )
                ) &&
            ...
            foreach ( ScheduledTransactionInfo scheduledTransactionInfo in scheduledTransactionInfoList.OrderByDescending( a => a.Id ) )
            {
                ...
                {
                    expirationMonth = scheduledTransactionInfo.FinancialPaymentDetail.FinancialPersonSavedAccount.FinancialPaymentDetail.ExpirationMonth;
                    expirationYYYY = scheduledTransactionInfo.FinancialPaymentDetail.FinancialPersonSavedAccount.FinancialPaymentDetail.ExpirationYear;
                }
        ...
        #region FinancialPersonSavedAccountService Code
        ...
        /// <returns></returns>
        private RemoveExpiredSavedAccountsResult RemoveExpiredSavedAccounts( int removedExpiredSavedAccountDays )
        {
